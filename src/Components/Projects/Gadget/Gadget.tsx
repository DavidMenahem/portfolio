...
function Gadget(): JSX.Element{
    return(<div className="gadget">
        ...
        <div className="gadget-images">
            <img src="https://i.postimg.cc/3WnpBy1M/gadget-login.png" alt="" className="image-gadget"></img>
            <img src="https://i.postimg.cc/7JYz4DxQ/gadget-add.png" alt="" className="image-gadget"></img>
            <img src="https://i.postimg.cc/MXWVV0yb/gadget-locate.png" alt="" className="image-gadget"></img>
        </div>
    </div>);
}
